...
export default function About() {
    ...
    // For change the stlye accoding to button
    ...
    // For change the button text
    const [btnText, setBtnText] = useState("Enable Dark Mode");

    // For change to the className of button
    ...
    return (
        <div classNameName="container my-3">
            ...
            <button type="button"  onClick={toggle} className= {btnClass}> {btnText} </button>
        </div>
    )
}
